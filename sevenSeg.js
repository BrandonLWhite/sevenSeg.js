...
$(function () {
    ...
    setInterval(function() {
        $("#testDiv").sevenSeg("displayValue", value, true);
        if(++value > 9) {value=0;}
    }, 200);
    ...
    var arrayValue = 0;
    setInterval(function() {
        $("#testArray").sevenSegArray("displayValue", arrayValue);
        if(++arrayValue > 999) {arrayValue=0;}
    }, 50);

    $("#testArray1").sevenSegArray({digits:5, value:-98.76, segmentOptions:{colorOff: "#003200", colorOn: "Lime", slant: 10}});
